...
double moistureThresholdMax = 28.0; 		//75.0
...
void setup()
{
	...
	sendMessageToDisplay("SETTING-UP");
...
void takeCareOfPlant()
{
	...
	sendMessageToDisplay("READ MOIST");
	...
	{
		sendMessageToDisplay("DEAD SENSOR!!"); // @suppress("Invalid arguments")
	}
	else
	{
...
{
	sendMessageToDisplay("WATERING PLANT");
